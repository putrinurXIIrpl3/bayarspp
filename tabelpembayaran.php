                ...
                <div class="container px-0">
                    ...
                    <nav class="navbar navbar-light navbar-expand-xl">
                        <a href="index.html" class="navbar-brand">
                            <h1 class="text-primary display-4">TABEL PEMBAYARAN</h1>
                        </a>
    ...
    <table class="table table-bordered table-striped table-striped">
      ...
      foreach ($input as $row) {
        echo "<tr>
                ...
                <td><a href='updatepembayaran.php?id_pembayaran=$row[id_pembayaran]'>Update</a>
               <a href='hapuspembayaran.php?id_pembayaran=$row[id_pembayaran]'>Hapus</a></td>
                </tr>";
        $no++;
      }
      ?>
