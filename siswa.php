                ...
                <div class="container px-0">
                    ...
                    <nav class="navbar navbar-light navbar-expand-xl">
                        <a href="index.html" class="navbar-brand">
                            <h1 class="text-primary display-4">FORM SISWA</h1>
                        </a>
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-6">
                        <div class="contact-form rounded p-5">
                            <form>
                                <h1 class="display-6 mb-4">SISWA</h1>
                                <div class="row gx-4 gy-3">
                                    <div class="col-xl-12">
                                        <input type="text" class="form-control bg-white border-0 py-3 px-4" placeholder="NIS">
                                    </div>
                                    <div class="col-xl-12">
                                        <input type="text" class="form-control bg-white border-0 py-3 px-4" placeholder="nama">
                                    </div>
                                    <div class="col-xl-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <a href="tabelsiswa.php">Data Siswa</a>
                                    </div>
                                </div>
                            </form>
                        </div>
